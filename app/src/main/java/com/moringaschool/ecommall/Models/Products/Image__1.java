...
public class Image__1 implements Serializable
{
    ...
    @Expose
    private ImageDimensions__1 imageDimensions;
    @SerializedName("meta")
    @Expose
    ...
    public ImageDimensions__1 getImageDimensions() {
        return imageDimensions;
    }

    public void setImageDimensions(ImageDimensions__1 imageDimensions) {
        this.imageDimensions = imageDimensions;
    }
