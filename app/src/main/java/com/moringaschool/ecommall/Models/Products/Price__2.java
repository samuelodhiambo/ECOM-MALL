...
public class Price__2 implements Serializable
{
    ...
    private final static long serialVersionUID = -2407144082931769234L;
     ...
     */
    public Price__2(Integer raw, String formatted, String formattedWithSymbol, String formattedWithCode) {
        super();
        this.raw = raw;
    ...
    public String toString() {
        ...
        sb.append(Price__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("raw");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Price__2) == false) {
            return false;
        }
        Price__2 rhs = ((Price__2) other);
