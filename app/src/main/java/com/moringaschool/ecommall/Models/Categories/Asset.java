...
public class Asset implements Serializable
{
    ...
    private final static long serialVersionUID = -5321008503809580764L;
     ...
     * @param updatedAt
     */
    public Asset(String id, String url, Object description, Boolean isImage, String filename, Integer fileSize, String fileExtension, ImageDimensions imageDimensions, List<Object> meta, Integer createdAt, Integer updatedAt) {
        super();
        this.id = id;
        this.url = url;
