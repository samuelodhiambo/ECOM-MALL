...
public class Datum_2 implements Serializable
{
    ...
    @Expose
    private List<Datum_3> relatedProducts = null;
     ...
     */
    public Datum_2(String id, Long created, Long quantity, Long updated, Boolean active, String permalink, String name, String description, Price__1 price, Inventory_1 inventory, CheckoutUrl checkoutUrl, List<VariantGroup> variantGroups, List<Category> categories, Image__1 image, List<Datum_3> relatedProducts) {
        super();
        this.id = id;
    ...
    public Datum_2(String id, Long created, Long updated, Boolean active, String permalink, String name, String description, Price__1 price, Inventory_1 inventory, CheckoutUrl checkoutUrl, List<VariantGroup> variantGroups, List<Category> categories, Image__1 image, List<Datum_3> relatedProducts) {
        super();
        this.id = id;
        this.created = created;
        this.updated = updated;
    ...
    public List<Datum_3> getRelatedProducts() {
        return relatedProducts;
    }

    public void setRelatedProducts(List<Datum_3> relatedProducts) {
        this.relatedProducts = relatedProducts;
    }
    ...
    public String toString() {
        ...
        sb.append(Datum_2.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Datum_2) == false) {
            return false;
        }
        Datum_2 rhs = ((Datum_2) other);
